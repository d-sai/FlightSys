...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        return Swal.fire('Error', data.message || 'Registration failed', 'error');
      }
  ...
  return (
    <div className="register-container">
      ...
      <FloatingAircraft delay={1} direction={-1} />
      <FloatingAircraft delay={2} direction={1} />
      ...
      >
        <div className="form-header">
          ...
          >
            Join the <span className="highlight">Aviation Academy</span>
          </motion.h2>
          <motion.p
          ...
          >
            Begin your journey to master the skies
          </motion.p>
        </div>
        ...
        >
          <div className="input-group">
            ...
            <motion.div
              className={`input-wrapper ${focusedField === 'role' ? 'focused' : ''}`}
              whileFocus={{ scale: 1.02 }}
            >
              <select
                name="role"
              ...
              >
                ...
                <option value="admin">👨‍✈️ Flight Instructor</option>
              </select>
              <div className="input-icon">🎯</div>
            </motion.div>
          </div>
